...
$.Hero.prototype.shootNearestEnemy = function () {
  ...
  $.audio.play("shoot");
  this.specials.shootNearestCooldown = 0.1; // 0.2 segundos de cooldown
};
...
$.Hero.prototype.dropBomb = function () {
  ...
  if (this.specials.bombUsed >= 5) {
    this.specials.bombCooldown = 25; // 20 segundos de recarga para 5 bombas
  }
...
$.Hero.prototype.activateShield = function () {
  if (this.specials.shieldCount > 0 && !this.specials.shieldActive) {
    ...
    this.specials.shieldTimer = 15;
    this.specials.shieldCount = 0;
  }
};
//quando o boss estive no mapa o escudo dura 20 segundos
//vou ter que criar uma funsão que verifica se o boss está no apa , se sim a durabilidade vai dura 20 egundos 
// depois  que o boss é derrotado  a  durabilidade volta a dura 15 segundos 
